  ...
  return (
    <div className="min-h-screen max-h-screen overflow-hidden flex flex-col lg:flex-row px-5 lg:px-[113px] lg:items-center py-4 lg:py-8 lg:gap-[174px]">
      <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-center">
        <Image src="/assets/waitlist.svg" width={490} height={459} alt="Waitlist" className="w-full h-auto max-h-[70vh] object-contain" />
      </div>
      ...
      <div className="flex-1 flex flex-col max-h-full overflow-y-auto lg:overflow-visible">
        ...
        <h1 className="text-[24px] text-shopta-text font-[700]">Be the first to know</h1>
        <h2 className="text-[16px] font-[600] text-shopta-text mt-3 lg:mt-5">We'd love to get your details</h2>
        
        
        <form onSubmit={handleSubmit} className="mt-4 lg:mt-6 space-y-3 lg:space-y-4">
          {/* First Name */}
          <div>
            <label className="block text-[14px] lg:text-[16px] font-[400] text-[#27272799] mb-1">First name</label>
            <input
              type="text"
              name="firstName"
            ...
            />
            {errors.firstName && <p className="text-red-500 text-[11px] mt-0.5">{errors.firstName}</p>}
          </div>

          {/* Last Name */}
          <div>
            <label className="block text-[14px] lg:text-[16px] font-[400] text-[#27272799] mb-1">Last name</label>
            <input
              type="text"
              name="lastName"
            ...
            />
            {errors.lastName && <p className="text-red-500 text-[11px] mt-0.5">{errors.lastName}</p>}
          </div>

          {/* Email Address */}
          <div>
            <label className="block text-[14px] lg:text-[16px] font-[400] text-[#27272799] mb-1">Email address</label>
            <input
              type="email"
              name="email"
          ...
          {/* Usage Dropdown */}
          <div>
            <label className="block text-[14px] lg:text-[16px] font-[400] text-[#27272799] mb-1">How would you like to use Shopta?</label>
            ...
            {errors.usage && <p className="text-red-500 text-[11px] mt-0.5">{errors.usage}</p>}
          </div>

          {/* Phone Number */}
          <div>
            <label className="block text-[14px] lg:text-[16px] font-[400] text-[#27272799] mb-1">Phone number</label>
            <input
              type="tel"
              name="phoneNumber"
